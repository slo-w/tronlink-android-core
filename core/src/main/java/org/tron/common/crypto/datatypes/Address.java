...
//        this(DEFAULT_LENGTH, StringTronUtil.un41Address(hexValue));
        this(DEFAULT_LENGTH, AddressUtil.replace41Address(hexValue));
    }

    public Address(String hexValue, boolean replace41) {
        this(DEFAULT_LENGTH, replace41 ? AddressUtil.replace41Address(hexValue) : hexValue);
    }
