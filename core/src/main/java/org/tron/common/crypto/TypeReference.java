 ...
 */
public abstract class TypeReference<T extends org.tron.common.crypto.datatypes.Type>
    ...
    public static <T extends org.tron.common.crypto.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends org.tron.common.crypto.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends org.tron.common.crypto.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends org.tron.common.crypto.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends org.tron.common.crypto.datatypes.Type> typeClass =
        ...
        final Class<? extends org.tron.common.crypto.datatypes.Type> baseClass =
